...
from vanilla import *
from AppKit import NSUserDefaults, NSClassFromString
...
class dialog(object):
    def __init__(self):
        ...
        self.w.editText1 = EditText(
            (50, L, -L, 22),
            placeholder="'tool' or 'path' or 'layer' or ...",
            callback=self.SavePreferences,
        )
        self.w.Text2 = TextBox((L, 40, -L, 22), "in:")
        self.w.editText2 = ComboBox(
            (50, 40, -L, 22),
            objectOptions,
            "GSWindowController",
            callback=self.SavePreferences,
        ...
        self.w.myButton = Button(
            (L, 70, -L, 20), "Show me!", callback=self.buttonCallback
        )
        self.w.center()
        self.w.open()
    ...
    def SavePreferences(self, sender):
        try:
            ...
            ] = self.w.editText1.get()
            Glyphs.defaults[
                "com.markfromberg.methodsearcher.editText2"
            ] = self.w.editText2.get()
        except:
            return False
    ...
    def LoadPreferences(self):
        try:
            ...
            self.w.editText1.set(
                Glyphs.defaults["com.markfromberg.methodsearcher.editText1"]
            )
            self.w.editText2.set(
                Glyphs.defaults["com.markfromberg.methodsearcher.editText2"]
            )
